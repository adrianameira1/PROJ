...
public class Metodopagamento {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "metodopagamento_id_gen")
    @SequenceGenerator(name = "metodopagamento_id_gen", sequenceName = "metodopagamento_id_metodo_seq", allocationSize = 1)
